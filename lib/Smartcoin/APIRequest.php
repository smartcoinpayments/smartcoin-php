...
class APIRequest
{
    ...
    public static function request(
        ...
        if (empty($method)) {
          throw new \Smartcoin\InvalidArgumentException("APIRequest::request has to have method");
        }

        if (empty($url)) {
            throw new \Smartcoin\InvalidArgumentException("APIRequest::request has to have url");
        }

        if (empty($api_keys)) {
            throw new \Smartcoin\InvalidArgumentException("No API Keys");
        }
